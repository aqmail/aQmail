...
echo "" >> "$OUTFILE"
echo "QMAILDIR="$QMAILDIR                       >> "$OUTFILE"
echo "UIDQ="`id -u $USRQ`                       >> "$OUTFILE"
echo "UIDR="`id -u $USRR`                       >> "$OUTFILE"
echo "UIDS="`id -u $USRS`                       >> "$OUTFILE"
echo "GIDQ=$(getent group $GRPS | cut -d: -f3)" >> "$OUTFILE"
